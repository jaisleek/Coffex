...
const ReviewCard = (props) => {
    return (
        <div className='flex flex-col w-full lg:w-2/6 bg-white p-3 rounded-lg gap-5'>
            ...
            <p>
                lorem ipsum dolor sit amet consectetur adipisicing elit. Laudanatium ab
                et optio labore perferebdis saepe, Fuga, delenti Laudanatium eos
                delectus cumque repudiantes ut deserunt 1d7
            </p>
        </div>
    )
}

...
import { SiCoffeescript } from 'react-icons/si'; // Correct import for the icon
import { Link } from 'react-scroll'; // Correct import for Link
      ...
      <div>
        <div className="flex flex-row justify-between p-5 lg:px-32 px-5 bg-gradient-to-r from-backgroundColor to-brightColor shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
          <div className="flex flex-row items-center cursor-pointer gap-2">
            ...
            <h1 className="text-xl font-semibold">CoffeX</h1>
          </div>
